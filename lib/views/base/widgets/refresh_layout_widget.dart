...
typedef HeaderTitleBuilder<T extends BasePageQueryController> = Widget Function(
    T controller);
typedef HeaderRightBuilder<T extends BasePageQueryController> = Widget Function(
    T controller);

class RefreshLayoutWidget<Controller extends BasePageQueryController>
