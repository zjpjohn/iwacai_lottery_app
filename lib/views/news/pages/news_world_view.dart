...
import 'package:iwacai_lottery_app/views/news/controller/news_world_controller.dart';
...
class NewsWorldView extends StatefulWidget {
  ///
  ///
  const NewsWorldView({Key? key}) : super(key: key);

  @override
  NewsWorldViewState createState() => NewsWorldViewState();
}

class NewsWorldViewState extends State<NewsWorldView>
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: RefreshWidget<NewsWorldController>(
        init: NewsWorldController(),
  ...
  Widget _buildNewsList(NewsWorldController controller) {
    return Container(
      color: Colors.white,
