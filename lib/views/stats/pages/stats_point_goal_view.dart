...
class StatsPointGoalView extends StatelessWidget {
  const StatsPointGoalView({Key? key}) : super(key: key);
        ...
        children: [
          Column(
            children: [
              ...
              Expanded(
                child: RequestWidget<StatsPointGoalController>(
                    builder: (controller) {
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: GetBuilder<StatsPointGoalController>(
                builder: (controller) {
                  return Row(
  ...
  Widget _buildStatsItem(StatsInfo<PointGoalStats> stat, bool bordered) {
    return Container(
