...
class StatsWinLossView extends StatelessWidget {
  const StatsWinLossView({Key? key}) : super(key: key);
        ...
        children: [
          Column(
            children: [
              ...
              Expanded(
                child: RequestWidget<StatsWinLossController>(
                    builder: (controller) {
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: GetBuilder<StatsWinLossController>(
                builder: (controller) {
                  return Row(
  ...
  Widget _buildStatsItem(StatsInfo<WinLossStats> stat, bool bordered) {
    return Container(
