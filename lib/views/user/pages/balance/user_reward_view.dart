...
import 'package:iwacai_lottery_app/views/user/pages/balance/reward_consume_view.dart';
import 'package:iwacai_lottery_app/views/user/pages/balance/reward_obtain_view.dart';
import 'package:iwacai_lottery_app/views/user/pages/balance/reward_withdraw_view.dart';
...
class UserRewardView extends StatefulWidget {
  ///
  ///
  const UserRewardView({Key? key}) : super(key: key);
