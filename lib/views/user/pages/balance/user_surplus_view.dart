...
import 'package:iwacai_lottery_app/views/user/pages/balance/surplus_consume_view.dart';
import 'package:iwacai_lottery_app/views/user/pages/balance/surplus_obtain_view.dart';
...
class UserSurplusView extends StatefulWidget {
  ///
  ///
  const UserSurplusView({Key? key}) : super(key: key);
