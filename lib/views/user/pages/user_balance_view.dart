...
import 'package:iwacai_lottery_app/views/user/pages/balance/user_reward_view.dart';
import 'package:iwacai_lottery_app/views/user/pages/balance/user_surplus_view.dart';
...
class UserBalanceView extends StatefulWidget {
  ///
  ///
  const UserBalanceView({Key? key}) : super(key: key);
...
class UserBalanceViewState extends State<UserBalanceView>
  ...
  ///tab选项页面
  List<Widget> views = [
    const UserRewardView(),
    const UserSurplusView(),
  ];
      ...
      child: Container(
        ...
        child: TabBar(
          ...
          indicator: CustomRRecTabIndicator(
            radius: 20.w,
            color: const Color(0xFFFFE7E7).withOpacity(0.75),
          ),
        ),
      ),
    );
