...
import 'package:iwacai_lottery_app/views/user/widgets/sign_widget.dart';
import 'package:iwacai_lottery_app/widgets/animate_number.dart';
import 'package:iwacai_lottery_app/widgets/clip_widget.dart';
import 'package:iwacai_lottery_app/widgets/custom_scroll_behavior.dart';
import 'package:iwacai_lottery_app/widgets/custome_card.dart';
import 'package:iwacai_lottery_app/widgets/dash_line.dart';
import 'package:iwacai_lottery_app/widgets/empty_widget.dart';
import 'package:iwacai_lottery_app/widgets/flip_card_widget.dart';
import 'package:iwacai_lottery_app/widgets/nav_app_bar.dart';

class UserSignView extends StatelessWidget {
  ///
  ///
  const UserSignView({Key? key}) : super(key: key);
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Expanded(
                  child:
                      RequestWidget<UserSignController>(builder: (controller) {
  ...
  Widget _buildCouponBalance(UserSignController controller) {
    ...
    return Container(
      height: 90.w,
      margin: EdgeInsets.symmetric(vertical: 12.w, horizontal: 24.w),
