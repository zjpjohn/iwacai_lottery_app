...
import 'package:iwacai_lottery_app/views/user/model/user_voucher.dart';
import 'package:iwacai_lottery_app/views/user/widgets/voucher_widget.dart';
...
class DrawVoucherView extends StatelessWidget {
  ///
  ///
  const DrawVoucherView({Key? key}) : super(key: key);
  ...
  Widget _buildVoucherList(
    DrawVoucherController controller,
  ) {
          ...
          child: Row(
            ...
            children: [
              Padding(
                ...
                child: Icon(
                  const IconData(0xe66c, fontFamily: 'iconfont'),
                  size: 14.sp,
