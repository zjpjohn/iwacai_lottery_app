...
import 'package:iwacai_lottery_app/views/user/model/message_center.dart';
...
class TextMessageWidget extends MessageWidget {
  ///
  ///
  const TextMessageWidget({Key? key, required MessageInfo message})
...
class LinkMessageWidget extends MessageWidget {
  ///
  ///
  const LinkMessageWidget({Key? key, required MessageInfo message})
      : super(key: key, message: message);
...
class CardMesageWidget extends MessageWidget {
  ///
  ///
  const CardMesageWidget({Key? key, required MessageInfo message})
      : super(key: key, message: message);
