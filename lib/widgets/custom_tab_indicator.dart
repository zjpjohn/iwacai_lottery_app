...
class CustomRRecTabIndicator extends Decoration {
  ...
  @override
  _RadiusIndicatorPainter createBoxPainter([VoidCallback? onChanged]) {
    return _RadiusIndicatorPainter(this, onChanged);
  }
}

class _RadiusIndicatorPainter extends BoxPainter {
  _RadiusIndicatorPainter(this.decoration, VoidCallback? onChanged)
      : super(onChanged);
