...
class WaTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<WaTabBar> createState() => _WaTabBarState();
}

class _WaTabBarState extends State<WaTabBar> {
  ...
  @override
  void didUpdateWidget(WaTabBar oldWidget) {
